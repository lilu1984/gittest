...
public class MoneyUtils {
	 ...
	 * 汉字 数字单位字符串
	 */
	private static String	HanStr[]		= new String[] { "〇", "一", "二", "三", "四", "五", "六", "七", "八", "九" };
	 ...
	 * 日期的年月日转为汉字字符串
	 */
	public static String DateIntegerToHanStr(String NumStr) { // 输入字符串必须正整数
		String RiQiStr = "";
		int len, n, n1, n2;
