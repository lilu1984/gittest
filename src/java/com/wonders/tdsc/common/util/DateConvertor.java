...
/**
 * Creation date: 2010-5-22下午03:41:58 功能: 将输入的日期转换为中文日期（例如: 2007-10-05 --> 二○○七年十月五日) 说明：此程序假定输入格式为yyyy-mm-dd, 且年月日部分都为数字, 没有加上非法 输入的相关校验 测试可以输入 2007-01-05 2007-1-05 2007-10-05
 */
public class DateConvertor {
	/**
	 * 描述：得到当前日期和时间使用 TimeZone yyyyMMddHHmmss
	 * 
	 * @param str
	 *            日期字符串
	 * @return
	...
	public static String getCurrentDateWithTimeZone() {
		DateFormat dateFormatterChina = DateFormat.getDateTimeInstance(DateFormat.MEDIUM, DateFormat.DEFAULT);// 格式化输出
