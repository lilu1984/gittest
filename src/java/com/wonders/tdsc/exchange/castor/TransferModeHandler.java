...
public class TransferModeHandler extends GeneralizedFieldHandler {
    /** »’÷æ */
    protected static Log logger = LogFactory.getLog(TransferModeHandler.class);


    /**
     * Creates a new MyDateHandler instance
     */
    public TransferModeHandler() {
        super();
    }
    ...
    public Object convertUponGet(Object value) {
        ...
        if (value == null || "".equals(value))
            return "";
        return DicDataUtil.getInstance().getDic(GlobalConstants.DIC_BLOCK_TRANSFER).get(value);
    }
