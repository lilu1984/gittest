...
public class GongdiTypeHandler  extends GeneralizedFieldHandler {
    /** »’÷æ */
    protected static Log logger = LogFactory.getLog(GongdiTypeHandler.class);


    /**
     * Creates a new MyDateHandler instance
     */
    public GongdiTypeHandler() {
        super();
    }
    ...
    public Object convertUponGet(Object value) {
        ...
        if (value == null || "".equals(value))
            return "";
        return DicDataUtil.getInstance().getDic(GlobalConstants.DIC_ID_GONGDI_TYPE).get(value);
    }
