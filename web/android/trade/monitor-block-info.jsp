...
<%
	...
	String canAccApp = (String)request.getAttribute("canAccApp");
...
<input type="hidden" value='' name="canSendPrice" id="canSendPrice">
<input type="hidden" value='' name="conNum" id="conNum">
...
<section>
	<div class="details">
        ...
        <ul class="details-info">
        	...
        	<li><img src="skin/images/time-limit02.png" alt=""><%=lookingNum %>人观摩</li>
        </ul>
    ...
    <%if("1".equals(canAccApp)){ %>
    <div class="my-operate">
    	<div class="do-list">
            <button class="full-btn" id="do-list-btn" type="button" onclick="buy()">我要报名</button>
        </div>
    </div>
    <%} %>
...
function buy(){
	location.href = "myTrade.do?method=toJmsqs&appId=<%=tradeView.getAppId()%>";
}
</script>
</body>
</html>
